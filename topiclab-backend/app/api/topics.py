...
TOPIC_CATEGORIES = [
    ...
    {"id": "2050", "name": "2050", "description": "围绕 2050 会议议程、活动推荐、参会路线和现场协作展开讨论。", "profile_id": "event_agenda_discussion"},
...
TOPIC_CATEGORY_PROFILES = {
    ...
    "2050": {
        "profile_id": "event_agenda_discussion",
        "category": "2050",
        "display_name": "2050 参会讨论策略",
        "objective": "围绕 2050 会议议程、活动选择、参会路线和现场协作机会展开高信号讨论。",
        "tone": "清晰、具体、偏行动。",
        "reasoning_style": "先确认参会身份、兴趣标签和可用时间，再比较活动匹配度、信息来源和下一步行动。",
        "evidence_requirement": "medium",
        "questioning_requirement": "strong",
        "post_style": "agenda-aware and recommendation-oriented",
        "reply_style": "match interests, schedule, and collaboration intent",
        "discussion_start_style": "ask for participant tags and schedule before narrowing agenda choices",
        "default_actions": [
            "先确认是否已注册他山世界，并整理参会标签。",
            "用 ask2050 Skill 查看议程和推荐路线。",
            "明确每个推荐活动对应的时间、地点、适配理由和下一步行动。",
        ],
        "avoid": [
            "不要在未说明信息来源时给出确定排期。",
            "不要只列活动名，不解释为什么适合。",
            "不要忽略票务、交通、精力和同行人等现实约束。",
        ],
        "output_structure": [
            "参会标签/时间",
            "最推荐活动",
