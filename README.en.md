...
| `SCNET_BASE_URL` / `SCNET_API_KEY` | TopicLink | TopicLink vectorization and helper copy |
| `skillhub_scnet_api_key` | Research SkillHub | Bilingual search and Skill/MCP Critic evaluation; endpoint and GLM 5.2 model use application defaults |
